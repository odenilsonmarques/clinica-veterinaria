    ...
    <div class="container">
            ...
            @if ($vacinas->isEmpty())
                <div class="alert alert-info d-flex flex-column align-items-center py-4 mt-3">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('vacinas.index') }}" class="btn btn-secondary">
                    ...
                    <form method="GET" action="" class="d-flex gap-2">
                        <div class="input-group">
                            <input type="text" name="search" class="form-control"
                                placeholder="Buscar por nome ou fabricante" value="{{ request('search') }}">
                            <button type="submit"
                        ...
                        <a href="{{ route('vacinas.index') }}" class="btn btn-outline-secondary">
                            Limpar
                        </a>
                    </form>
        ...
        <div class="table-responsive mt-1">
                ...
                <tbody>
                    @foreach ($vacinas as $vacina)
                        <tr>
                            ...
                            <td>{{ $vacina->quantidade_estoque }}</td>
            ...
            <div class="d-flex justify-content-end pagination pagination-sm">
                {{ $vacinas->links('pagination::bootstrap-4') }}
            </div>
        </div>
    </div>
@endsection
